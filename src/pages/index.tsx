  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Tile Simulator" />
        <meta property="og:description" content="Deployed on Vercel" />
        <meta property="og:url" content="https://tile-simulator.vercel.app/" />
